   ...
   ?>
            ...
            <div class="col-lg-4">
               <div class="p-3 border bg-light">
                  ...
                  <a class="click-btn" href="resimpproject.php" >Click here</a>
               </div>
            </div>
            <div class="col-lg-4">
               <div class="p-3 border bg-light">
                  ...
                  <a class="click-btn" href="impactproject.php" >Click here</a>
               </div>
            </div>
            <div class="col-lg-4">
               <div class="p-3 border bg-light">
                  ...
                  <a class="click-btn" href="collab.php" >Click here</a>
               </div>
            </div>
            <div class="col-lg-4">
               <div class="p-3 border bg-light">
                  ...
                  <a class="click-btn" href="rev.php" >Click here</a>               
               </div>
            </div>
         </div>
      </div>
